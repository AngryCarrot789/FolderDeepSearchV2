...
namespace FolderDeepSearchV2.Imaging {
    public static class ShellUtils {
        ...
        public static Icon GetFileIcon(string path, IconType iconType, bool isDirectoryOrDrive) {
            uint flags = SHGFI_ICON | SHGFI_USEFILEATTRIBUTES;
            switch (iconType) {
                case IconType.Small: flags |= SHGFI_SMALLICON;
                    break;
                case IconType.Large: flags |= SHGFI_SHELLICONSIZE;
                    break;
            }
